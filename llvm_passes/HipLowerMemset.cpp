...
// llvm-spirv translator. The translator expands memset intrinsics to emulation
// function with a name encoding the destination pointer type
...
//   type arguments!
//
// llvm.memcopy does not have this issue as it gets translated to actual SPIR-V
